...
public class Instantiation implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2024"), "Bora Brasil", "Amanha nas olimpiadas o brasil vai ganhar", mano);
		Post post2 = new Post(null, sdf.parse("23/03/2016"), "Que dia Terrivel", "Acordei depressivo hoje", bob);
